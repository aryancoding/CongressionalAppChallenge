  ...
  render() {
    ...
    return (
      <Block padding={[100, theme.sizes.base * 2]}>
        <Text h1 bold style={{ paddingBottom: 50 }}>Volunteer</Text>
        <Text h4 bold style={styles.borderPreviousOrders}>Previous Orders (Completed):</Text>
        ...
        <Button gradient onPress={() => navigation.navigate("CompletedOrders")}>
              <Text
                bold
                white
                center
